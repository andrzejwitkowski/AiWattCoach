...
## Corpus Check
- 825 files · ~521,631 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9980 nodes · 13526 edges · 771 communities detected
...
Cohesion: 0.02
Nodes (167): AiAgentsDto, AvailabilityDayDto, AvailabilityDayRequest, AvailabilityDto, CalendarActivityLabelDto, CalendarCustomLabelDto, CalendarEventDto, CalendarHealthLabelDto (+159 more)
...
Cohesion: 0.03
Nodes (45): buildTestStatusMessage(), clearDraftApiKeys(), clearTestStatusIfNeeded(), handleSave(), handleTest(), setStatusFromTest(), updateDraft(), updateProvider() (+37 more)
...
Cohesion: 0.04
Nodes (27): IntervalsService<Api, Settings, Activities, UploadOperations, Extractor, PocRepo, Time, Refresh>, IntervalsService<Api, Settings, Activities, UploadOperations, Extractor, PocRepo, Time, Refresh>, builds_failed_poc_record(), builds_parsed_poc_record(), mongo_fixture_or_skip(), MongoFixture, noop_poc_repository_accepts_records(), pest_parser_poc_repository_creates_expected_indexes() (+19 more)
...
## Knowledge Gaps
- **1627 isolated node(s):** `StoredConversation`, `DetailBackfillCall`, `MetricsBackfillRange`, `MetricsBackfillCall`, `ManualWahooSyncCall` (+1622 more)
...
- **Why does `IntervalsService<Api, Settings, Activities, UploadOperations, Extractor, PocRepo, Time, Refresh>` connect `Community 21` to `Community 27`, `Community 14`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `race_label()` connect `Community 17` to `Community 11`?**
