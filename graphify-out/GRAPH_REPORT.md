...
## Corpus Check
- 801 files · ~501,491 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8464 nodes · 11316 edges · 778 communities detected
...
8. `sample_context()` - 25 edges
9. `sample_planned_workout()` - 25 edges
10. `required_settings_map()` - 24 edges
...
## Knowledge Gaps
- **765 isolated node(s):** `StoredConversation`, `DetailBackfillCall`, `MetricsBackfillRange`, `MetricsBackfillCall`, `ManualWahooSyncCall` (+760 more)
