...
pub(super) fn map_document_to_domain(doc: SettingsDocument) -> Result<UserSettings, SettingsError> {
    Ok(UserSettings {
        ...
        ai_agents: AiAgentsConfig {
            ...
            plan_quality_pass_score: doc.ai_agents.plan_quality_pass_score,
...
pub(super) fn map_document_cycling_to_domain(cycling: CyclingDocument) -> CyclingSettings {
    CyclingSettings {
...
pub(super) fn repair_availability_days(days: Vec<AvailabilityDayDocument>) -> Vec<AvailabilityDay> {
...
pub(super) fn has_complete_explicit_week(days: &[AvailabilityDayDocument]) -> bool {
