...
#[derive(Serialize)]
pub(super) struct ActivityMetricsDto {
    #[serde(rename = "trainingStressScore")]
    pub training_stress_score: Option<i32>,
    #[serde(rename = "normalizedPowerWatts")]
    pub normalized_power_watts: Option<i32>,
...
#[derive(Serialize)]
pub(super) struct ActivityDetailsDto {
...
#[derive(Serialize)]
pub(super) struct ActivityIntervalDto {
    pub id: Option<i32>,
...
#[derive(Serialize)]
pub(super) struct ActivityIntervalGroupDto {
    pub id: String,
...
#[derive(Serialize)]
pub(super) struct ActivityStreamDto {
...
#[derive(Serialize)]
pub(super) struct ActivityZoneTimeDto {
    #[serde(rename = "zoneId")]
    pub zone_id: String,
    pub seconds: i32,
}
