...
export function CalendarCoachFab({ onClick }: CalendarCoachFabProps) {
  ...
  return (
    <button
      ...
      className="safe-bottom-inset fixed bottom-4 right-4 z-40 inline-flex items-center gap-3 overflow-hidden rounded-full border border-[#d2ff9a]/30 bg-[#0f1511]/95 px-4 py-3 text-left shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur transition hover:-translate-y-0.5 hover:border-[#d2ff9a]/55 hover:bg-[#131a15] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d2ff9a]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0f1a] md:bottom-6 md:right-6 md:px-5"
    >
