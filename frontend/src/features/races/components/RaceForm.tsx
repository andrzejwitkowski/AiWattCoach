...
export function RaceForm({ apiBaseUrl, race, onCancel, onSaved }: RaceFormProps) {
  ...
  return (
    <section className="rounded-[1.75rem] border border-white/8 bg-[linear-gradient(180deg,rgba(23,18,13,0.98),rgba(14,11,9,0.95))] p-6 shadow-[0_22px_80px_rgba(0,0,0,0.34)]">
