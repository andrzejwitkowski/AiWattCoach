...
const aiAgentsSettingsSchema = z.object({
  ...
  planQualityEvaluatorProvider: llmProviderSchema.nullable().optional(),
  planQualityEvaluatorModel: z.string().nullable().optional(),
  planQualityMaxLoops: z.number().int().min(1).max(10).nullable().optional(),
  planQualityPassScore: z.number().int().min(1).max(10).nullable().optional(),
...
export const updateAiAgentsRequestSchema = z.object({
  ...
  mesoCycleModel: z.string().nullable().optional(),
  planQualityEvaluatorProvider: z.union([llmProviderSchema, z.literal('')]).nullable().optional(),
  planQualityEvaluatorModel: z.string().nullable().optional(),
  planQualityMaxLoops: z.number().int().min(1).max(10).nullable().optional(),
  planQualityPassScore: z.number().int().min(1).max(10).nullable().optional(),
