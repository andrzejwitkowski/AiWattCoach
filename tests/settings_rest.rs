...
use aiwattcoach::{
    ...
    domain::intervals::{IntervalsConnectionError, IntervalsConnectionTester},
    domain::settings::{
...
async fn settings_test_app_with_intervals(
    identity_service: impl IdentityUseCases + 'static,
    settings_service: impl UserSettingsUseCases + 'static,
...
impl MockIntervalsConnectionTester {
    ...
    fn returning_err(err: IntervalsConnectionError) -> Self {
        Self::new(Err(err))
    }
}
